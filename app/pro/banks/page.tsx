...
// ════════════════════════════════════════════════════════════════════════
//  /pro/banks — Vue pipeline bancaire
//  Kanban : pour chaque dossier, où en est-on avec chaque banque
// ════════════════════════════════════════════════════════════════════════
      ...
      <div className="bg-white border-b border-slate-200 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between gap-4">
          <div className="pl-12 lg:pl-0">
            <h1 className="text-xl font-semibold text-slate-900 tracking-tight">Pipeline bancaire</h1>
      ...
      <main className="max-w-7xl mx-auto px-6 py-6">
        ...
        {submissions.length === 0 ? (
          <div className="bg-white border border-slate-200 rounded-xl p-12 text-center max-w-2xl mx-auto">
            ...
            <h2 className="text-sm font-semibold text-slate-900 mb-1">Aucun dossier envoyé en banque</h2>
            <p className="text-xs text-slate-500 mb-5 max-w-md mx-auto">
              Quand vous ouvrirez un prospect et noterez les banques sollicitées, le pipeline apparaîtra ici.
            </p>
