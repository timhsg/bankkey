    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-slate-100">
        <div className="max-w-6xl mx-auto px-5 h-16 flex items-center justify-between">
          <div className="font-bold text-xl text-slate-900">Credify</div>
      ...
      <section className="max-w-5xl mx-auto px-5 py-32 text-center space-y-8">
        ...
        <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
          Chaque heure où vous tardez, un lead va chez le concurrent. Credify qualifie, score et prépare votre réponse automatiquement.
        </p>
        ...
        <div className="max-w-5xl mx-auto px-5">
          <div className="grid md:grid-cols-2 gap-16 items-center mb-16">
            <div className="space-y-6">
              <h2 className="text-4xl font-bold text-slate-900">Le vrai problème</h2>
      ...
      <section id="features" className="max-w-5xl mx-auto px-5 py-24">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            { icon: '🔗', title: 'Connexion Gmail', desc: 'Connectez en 1 clic. Credify lit vos demandes et analyse automatiquement.' },
        ...
        <div className="max-w-6xl mx-auto px-5">
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex items-center gap-6">
              ...
              <a href="mailto:support@credify.ch" className="text-sm hover:text-white">Support</a>
            </div>
          </div>
          <p className="text-sm text-slate-500">
            Credify © 2025 — Qualification IA pour courtiers en crédit immobilier
          </p>
        </div>
      </footer>
    </div>
